...
def And(*xs: Expr) -> Node:
    return Node("and", list(xs))


def Or(*xs: Expr) -> Node:
    return Node("or", list(xs))


def Implies(a: Expr, b: Expr) -> Node:
    return Node("=>", [a, b])


def Iff(a: Expr, b: Expr) -> Node:
    return Node("=", [a, b])  # ↔ come '=' booleana


def Xor(a: Expr, b: Expr) -> Node:
    return Node("xor", [a, b])
