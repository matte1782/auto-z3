...
ITALY_REGIONS = [
    "VDA","PIE","LOM","LIG","TAA","VEN","FVG",
    "EMR","TOS","UMB","MAR","LAZ","ABR","MOL",
    "CAM","PUG","BAS","CAL","SIC","SAR",
]
ITALY_LABELS = {
    "VDA":"Valle d’Aosta","PIE":"Piemonte","LOM":"Lombardia","LIG":"Liguria","TAA":"Trentino-Alto Adige",
    "VEN":"Veneto","FVG":"Friuli-Venezia Giulia","EMR":"Emilia-Romagna","TOS":"Toscana","UMB":"Umbria",
    "MAR":"Marche","LAZ":"Lazio","ABR":"Abruzzo","MOL":"Molise","CAM":"Campania","PUG":"Puglia",
    "BAS":"Basilicata","CAL":"Calabria","SIC":"Sicilia","SAR":"Sardegna",
}
# Adiacenze curate a mano (29E24)
ITA_EDGES = [
    ("VDA","PIE"),("VDA","LOM"),
    ("PIE","VDA"),("PIE","LOM"),("PIE","LIG"),("PIE","TAA"),
    ("LOM","VDA"),("LOM","PIE"),("LOM","LIG"),("LOM","TAA"),("LOM","VEN"),("LOM","EMR"),
    ("LIG","PIE"),("LIG","LOM"),("LIG","EMR"),
    ("TAA","PIE"),("TAA","LOM"),("TAA","VEN"),
    ("VEN","LOM"),("VEN","TAA"),("VEN","FVG"),("VEN","EMR"),
    ("FVG","VEN"),("FVG","EMR"), # FVG–EMR solo via mare? se vuoi rimuovi
    ("EMR","LIG"),("EMR","LOM"),("EMR","VEN"),("EMR","TOS"),("EMR","MAR"),
    ("TOS","EMR"),("TOS","LIG"),("TOS","UMB"),("TOS","MAR"),("TOS","LAZ"),
    ("UMB","TOS"),("UMB","MAR"),("UMB","LAZ"),
    ("MAR","EMR"),("MAR","TOS"),("MAR","UMB"),("MAR","LAZ"),("MAR","ABR"),
    ("LAZ","TOS"),("LAZ","UMB"),("LAZ","MAR"),("LAZ","ABR"),("LAZ","MOL"),("LAZ","CAM"),
    ("ABR","MAR"),("ABR","LAZ"),("ABR","MOL"),
    ("MOL","ABR"),("MOL","LAZ"),("MOL","CAM"),("MOL","PUG"),
    ("CAM","LAZ"),("CAM","MOL"),("CAM","PUG"),("CAM","BAS"),
    ("PUG","MOL"),("PUG","CAM"),("PUG","BAS"),
    ("BAS","PUG"),("BAS","CAM"),("BAS","CAL"),
    ("CAL","BAS"),
    # isole separate
]
